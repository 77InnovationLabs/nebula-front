        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            <div className="col-span-2">
              <div className="text-2xl font-bold text-indigo-600 mb-4">NebulaQuest</div>
              <div className="flex">
                <input 
                  type="email" 
                  placeholder="Your email here" 
                  className="flex-1 px-4 py-2 border border-gray-300 text-gray-500 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li><a href="#" className="hover:text-indigo-600">GDPR Compliance</a></li>
                <li><a href="#" className="hover:text-indigo-600">Access Policy</a></li>
                <li><a href="#" className="hover:text-indigo-600">User Agreement</a></li>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">© 2024 NebulaQuest. All rights reserved.</p>
